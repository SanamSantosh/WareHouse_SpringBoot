...
<body align="center">
	...
	<table border="1" align="center">
		<tr>
			<td>Item Name:</td>
			<td><input type="text" value=<%=itemInfoObj.getName()%> readonly></td>
		</tr>
		<tr>
			<td>Price:</td>
			<td><input type="text" value=<%=itemInfoObj.getPrice()%>
				readonly></td>
		</tr>
		<tr>
			<td>Price After Discount:</td>
			<td><input type="text" value=<%=discount%> readonly></td>
		</tr>
		<tr>
			<td>Stock:</td>
			<td><input type="text" value=<%=itemInfoObj.getStock()%>
				readonly></td>
		</tr>
	</table>
	<br>
