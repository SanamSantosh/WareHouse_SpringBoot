...
<body>
	<form name="index" style="text-align: center" method="post"
		...
		<table border="1" align="center">
			...
			<tr>
				<td>Item Id:</td>
				<td><input type="text" name="itemid" value="" required></td>
			</tr>
			<tr>
				<td>Merchant Id:</td>
		...
		<a href="MerchantHomePage.jsp"><input type="button" name="button"
			value="back"></a> <a href="MerchantLogin.jsp"><input
			type="button" name="button" value="logout"></a>
	</form>
</body>
</html>