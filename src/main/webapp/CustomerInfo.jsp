...
<body align="center">
	...
	<table border="1" align="center">
		<tr>
			<td>Customer Name:</td>
			<td><input type="text" value=<%=custObj.getName() %> readonly></td>
		</tr>
		<tr>
			<td>Phone Number:</td>
			<td><input type="text" value=<%=custObj.getPhonenumber() %>
				readonly></td>
		</tr>
		<tr>
			<td>Address:</td>
			<td><input type="text" value=<%=custObj.getAdderss() %> readonly></td>
		</tr>
	</table>
	<%} %>
	<br>
