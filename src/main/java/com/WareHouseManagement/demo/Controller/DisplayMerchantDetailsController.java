...
public class DisplayMerchantDetailsController {
	//this method is used for getting the list of merchant details from the rest controller
	...
	public ModelAndView CheckMerchantDetails()
	{
		...
		ResponseEntity<List<MerchantStock>>  status=rt.exchange(url, HttpMethod.GET,requestEntity, new ParameterizedTypeReference<List<MerchantStock>>() {});
